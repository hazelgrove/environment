...
type node = PConst of Const.t | PVar of Var.t | PCons of t * t | PWild
...
type z_node = Cursor of node | PCons_L of z_t * t | PCons_R of t * z_t
...
type p_t = Const of Const.t | Var of Var.t | Cons of p_t * p_t | Wild
[@@deriving sexp]
...
let rec z_equal (p1 : z_t) (p2 : z_t) =
  ...
  | PCons_L (zp1, p1), PCons_L (zp2, p2) | PCons_R (p1, zp1), PCons_R (p2, zp2)
    ->
